...
export default function Home() {
  ...
  function openOrder() { setOrderLines([{ productId: products[0].id, quantity: 1, presentation:"", notes:"", alternatives:[] }]); setModal("order"); }
